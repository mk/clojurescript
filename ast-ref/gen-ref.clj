  ...
  (if (some #(:optional (meta %)) children)
    (let [[c & rest] children]
      (let [k (build-children rest)
        ...
        (if (:optional (meta c)) (into k kc) kc)))
...
(def nodes
  (apply str
    (for [{:keys [op doc keys]} (:node-keys tej-ref)
          :let [op (name op)]]
      (str "<section>"
           "<h2>"
           "<a href=\"#"
           ...
           (apply str
             (for [[k d :as f] keys]
               (str "<dt>"
                    ...
                    "</dt>"
                    "<dd>"
                    (if (:optional (meta f)) "<b>optional</b> ")
                    (fix d)
                    "</dd>")))
           (if-let [c (children keys)]
             (str "<dt> :children </dt> <dd> "
                  (join ", " (mapv (fn [c] (str "<code>" c "</code>")) c))
                  "</dd>"))
           "</dl>"
           "</section>\n"))))
