...
(defn fn-returning-this [x] (this-as this this))
...
(deftest meta-fn-test
  ...
  #_(is
      (= (range 21) (apply meta-f (range 21)))
  ...
  #_(is
      (= (range 22) (apply meta-f (range 22)))
      "Should properly call the last IFn arity with 20 args with last being a seq")
...
(deftest multi-arity-test
  ...
  (is (thrown? js/Error (apply (fn ([a b] a) ([a b c] a)) [1]))))

(deftest single-arity-variadic-test
  (doseq [f [(fn [& r] r) (fn [a & r] (list* a r)) (fn [a b & r] (list* a b r))
  ...
  (is (nil? (apply (fn [a & b] b) [1])) "rest should stay nil")
  (is (nil? (apply (fn [a & b] b) 1 [])) "rest should be nil'd")
  (is (= '(2) (apply (fn [a & b] b) 1 [2])) "rest should be nil'd")
  (is (= (range 30)
...
(deftest multi-arity-variadic-test
  (doseq [f [(fn ([]) ([& r] r)) (fn ([a]) ([a & r] (list* a r)))
...
(deftest incorrect-invokes-m-arity-test
  ;; This is the fault of .call currently not throwing. Can't be caught by
  ;; apply:
  #_(is (thrown? js/Error (apply (fn ([a b] a) ([a b & c] a)) [1]))
