...
(deftest test-suggestion
  (testing "suggestion"
           (is (= ":optimization"
                  (util/suggestion 3
                                   ":optimization"
                                   [":optimization" ":static-fns"])))))

(deftest test-unknown-opts
  (testing "unknown-opts"
           (is (= [[:bogus nil] [:optimisations :optimizations]]
                  (sort (util/unknown-opts #{:optimisations :bogus}
                                           #{:optimizations :static-fns}))))))
...
(deftest test-relative-name
  (if util/windows?
    (let [initial (System/getProperty "user.dir")]
      (System/setProperty
        "user.dir"
        "C:\\Users\\anmonteiro\\Downloads\\clojurescript-master")
      (is
        (=
          (util/relative-name
            (io/file
              "C:\\Users\\anmonteiro\\Downloads\\clojurescript-master\\out\\index.js"))
          "out\\index.js"))
      (is
        (=
          (util/relative-name
      ...
      (is
        (=
          ...
          "node_modules\\lodash\\array.js"))
      ;; Check pass-through:
      (is (= (util/relative-name (io/file
                                   "C:\\Temp\\clojurescript\\out\\index.js"))
             "C:\\Temp\\clojurescript\\out\\index.js"))
    ...
    (let [initial (System/getProperty "user.dir")]
      ...
      (is (= (util/relative-name (io/file
                                   "/Users/user/clojurescript/out/index.js"))
             "out/index.js"))
      (is (= (util/relative-name
               (io/as-url (io/file "/Users/user/clojurescript/out/index.js")))
             "out/index.js"))
      ;; Check pass-through:
      (is (= (util/relative-name (io/file "/tmp/clojurescript/out/index.js"))
             "/tmp/clojurescript/out/index.js"))
      (System/setProperty "user.dir" initial))))

(deftest test-path
  (is (= (.getAbsolutePath (io/file "src/main/clojure/cljs/closure.clj"))
         (util/path (io/as-url (io/file
