...
(defn delete-out-files
  ...
  ([directory]
   (doseq [f (file-seq (io/file directory)) :when (.isFile f)] (.delete f))))
...
(defn project-with-modules
  ...
  {:inputs (str (io/file "src" "test" "cljs")),
   :opts {:main "module-test.main",
          :output-dir output-dir,
          :optimizations :advanced,
          :verbose true,
          :modules
            {:cljs-base {:output-to (str (io/file output-dir
                                                  "module-main.js"))},
             :module-a {:output-to (str (io/file output-dir "module-a.js")),
                        :entries #{'module-test.modules.a}},
             :module-b {:output-to (str (io/file output-dir "module-b.js")),
...
(defn platform-path [path] (.replace path \/ (.charAt (str File/separator) 0)))
