...
(ns cljs.env.macros (:refer-clojure :exclude [binding ensure]))
            ...
            (throw
              (js/Error.
                (str
                  ...
                  (type env#)))))]
     (cljs.core/binding [cljs.env/*compiler* env#] ~@body)))
...
(defmacro ensure
  ...
  `(let [val# cljs.env/*compiler*]
     ...
     (try ~@body (finally (when (nil? val#) (set! cljs.env/*compiler* nil))))))
