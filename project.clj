(defproject org.clojure/clojurescript "0.0-SNAPSHOT"
  ...
  :jvm-opts ^:replace
            ["-Dclojure.compiler.direct-linking=true" "-Xmx512m" "-server"]
  :source-paths ["src/main/clojure" "src/main/cljs"]
  :resource-paths ["src/main/cljs" "resources"]
  :test-paths
    ["src/test/clojure" "src/test/cljs" "src/test/self" "src/test/cljs_cp"]
  ...
  :profiles {:1.6 {:dependencies [[org.clojure/clojure "1.6.0"]]},
             ...
             :closure-snapshot
               {:dependencies [[com.google.javascript/closure-compiler-unshaded
                                "1.0-SNAPSHOT"]]}}
